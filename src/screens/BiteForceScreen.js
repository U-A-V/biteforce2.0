...
import { StyleSheet, Text, View, ScrollView, TouchableWithoutFeedback, Keyboard, Modal, Alert, TouchableOpacity } from 'react-native';
    ...
    return (
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.container}>
          ...
          >
            <Text style={{ fontSize: 16, fontWeight: 'bold', marginHorizontal: 5}}>Reset</Text>
          ...
          <View style={styles.horizontalButtonContainer}>
            <View style={{ flex: 1, marginRight: 5 }} >
              <Button raised title='Measure' type="outline" buttonStyle={styles.buttonOutline} onPress={() => { this.measureValue() }} titleStyle={{ color: '#0fc1a7' }} />
            </View>
          ...
          <View style={{ ...styles.buttonContainer, marginBottom: 80 }} >
            <Button raised title="Generate" onPress={this.isDropDownSelected} buttonStyle={styles.button} />
          </View>
          <ProgressDialog
